...
public class DataCrawlerAgent extends Agent 
{
	...
	//S private LinkedHashMap<String,String> followeeFollowerNames; //Followees and number of followers to obtain  Added by Sepide
	...
	protected void setup() 
	{
		...
		//S followeeFollowerNames = (LinkedHashMap<String,String>) args[0];  // Added by Sepide
	...
	private class CollectBehaviour extends OneShotBehaviour {		
		...
		public void action() {
			...
			if (!collectingData)
			{
				...
				//S for (String followeeName : followeeFollowerNames.keySet()) // added by Sepide
					...
					
				{
					...
					if (longFollowerIDs.length > 0){
						...
						//S FollowerNameToGet = followeeFollowerNames.get(followeeName);  // added by Sepide
